...
def main(host: str, port: int):
    skill = AgentSkill(
        id="birthday-email-agent",
        name="Birthday Email Agent",
        description="An AI agent that generates cheerful and personalized birthday greeting emails for employees",
        tags=["birthday", "email", "agent"],
        examples=["Write a birthday greeting email for John", "Generate a cheerful birthday message for an employee"],
    )
