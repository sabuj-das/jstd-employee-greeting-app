...
def main(host: str, port: int):
    skill = AgentSkill(
        id="anniversary-email-agent",
        name="Anniversary Email Agent",
        description="An AI agent that generates warm and personalized work anniversary greeting emails for employees",
        tags=["anniversary", "email", "agent"],
        examples=["Write a work anniversary email for Sarah who has been with the company 5 years", "Generate an anniversary greeting for an employee completing 10 years of service"],
    )
